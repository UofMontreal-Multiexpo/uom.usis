# uom.usis 1.1.0.9000-4 (development version)



# uom.usis 1.1.0-4 (2024-09-16)
...
* Links to the main associated datasets have been added to the help pages of the functions `join_USIS`, `join_IMIS` and `join_OIS`.
